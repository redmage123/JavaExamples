...
class EmailMessage1 {
	...
	// The outer class constructor is private and contains no statements. That's
	// because we're never
	// going to call the outer class constructor directly and instead do all the
	// work through the static
	...
	public static class Builder {
		...
		public EmailMessage1 build() {
			// Finally, return the completely built emailInstance to the client
			// application.
	...
	public static Builder builder() {
		// Construct the email message by calling the static nested class
		// Builder.
...
public class JavaEmailExample2 {
	public static void main(String args[]) {
		...
		// Here we see an example of using the builder design pattern when
		// constructing our email.
		EmailMessage1 em = EmailMessage1.builder().from("bbrelin@gmail.com")
