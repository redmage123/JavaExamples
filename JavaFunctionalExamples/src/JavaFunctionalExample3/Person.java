...
public class Person {
	...
	public class manageContactInfo {
		...
		/*
		 * Here we're supplying the Emergency Contact List from the driver
		 * application.
		 */
	...
	public Person(String pId, String n, String addr, String t, Integer a,
			List<EmergencyContactInfo> l) {
		this.name = n;
		this.address = addr;
		this.telephone = t;
		this.age = a;
	...
	public String toString() {
		return this.pID + " " + this.name + " " + this.address + " "
				+ this.telephone + " " + this.age;
	}

	// We'll be putting Persons into a HashMap, so we'll need to override the
	// default equals and hashCode
	// methods, otherwise we'll get undefined results from comparing Person
	...
	public boolean equals(Object other) {
		...
		return this.pID == o.pID && this.name == o.name
				&& this.address == o.address && this.telephone == o.telephone
				&& this.age == o.age;
	}
	...
	public int hashCode() {
		int prime = 29;
		int hash = 1;
		return prime * Integer.parseInt(this.pID) * this.name.hashCode()
				* this.address.hashCode() * this.telephone.hashCode()
				* this.age;
	}

	// Give me back an emergency contact list, sorted in order of the first
	// person to contact.
