...
public class ComparatorExample {
    public static void main(String argv[]) {
        ...
        if (dogList.get(0).compareTo(dogList.get(1))  < 0 ) {
            System.out.println(dogList.get(0).getDogName() + " is less than " +  dogList.get(1).getDogName());
        } else if (dogList.get(0).compareTo(dogList.get(1)) == 0) {
            System.out.println(dogList.get(0).getDogName() + " is equal to " +  dogList.get(1).getDogName());
        } else {
            System.out.println(dogList.get(0).getDogName() + " is greater than " +  dogList.get(1).getDogName());
        }
