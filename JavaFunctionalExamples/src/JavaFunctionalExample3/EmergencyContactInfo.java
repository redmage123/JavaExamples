...
class EmergencyContactInfo implements Comparable<EmergencyContactInfo> {
	...
	/*
	 * One of the EmergencyContactInfo attributes is the priority. This is a
	 * measure of whom to call first in the case of an emergency. Obviously we
	 * want the user to be able to quickly determine who the first person is
	...
	public String toString() {
		return contactName + " " + contactTelephone + " " + contactAddress
				+ " " + priority;
	}
}
